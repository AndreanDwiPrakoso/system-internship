        ...
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header d-flex align-items-center">
                <a class="navbar-brand" href="https://soloabadi.com/" target="_blank">
                    <img src="<?= base_url('assets/'); ?>img/brand/logo-sobad.png" class="navbar-brand-img">
                </a>
                <div class="ml-auto">
                    <!-- Sidenav toggler -->
                    ...
                    <div class="card">
                        ...
                        <div class="container">
                            <?php foreach ($edit as $data) : ?>
                                <form action="<?= base_url() . 'c_admin/update_detail'; ?>" method="POST" class="needs-validation" novalidate>
